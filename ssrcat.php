...
for ($i=0;$i<=5;$i++)
{
    $img = "https://shadowsocksr.cat/".$matches[1][$i];
    ...
    if ($i <= 2)
    {
        ...
        $ip = "$pub[1]";
        $port = $arr[2];
        echo "<tr><td>".$ip."</td>"."<td>".$port."</td>"."<td>".$method."</td>"."<td>".$secret."</td><td></td><td><i class='fa fa-qrcode' aria-hidden='true'></i></td></tr>";
    }else{
